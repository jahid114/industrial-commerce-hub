          ...
          {nav.map((it) => {
            ...
            const linkEl = (
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg py-3 text-sm font-medium transition-colors ${collapsed ? "justify-center px-2" : "px-4"} ${isActive ? "bg-sidebar-primary text-sidebar-primary-foreground" : "text-sidebar-foreground hover:bg-sidebar-accent"}`}
              >
