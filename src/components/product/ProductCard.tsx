...
export function ProductCard({ product, index = 0, portal = false }: { product: Product; index?: number; portal?: boolean }) {
  ...
  const detailLink = portal
    ? ({ to: "/portal-customer/catalog/$productId", params: { productId: product.id } } as const)
    : ({ to: "/products/$productId", params: { productId: product.id } } as const);
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <Link {...detailLink} className="text-left">
